document.addEventListener("DOMContentLoaded", function() {
  ...
  function agregarProfesorAGrupo() {
    ...
    // Agregar un nuevo console.log para mostrar los datos enviados
  console.log("Datos enviados:", "materia=" + materiaSeleccionada + "&grupo=" + grupoSeleccionado);
  ...
  agregarButton.addEventListener("click", function() {
    console.log("Clic en el botón 'Agregar'");
    agregarProfesorAGrupo();
  });

  // Crear las filas de la tabla con los datos obtenidos de profesor_grupo
  for (var i = 0; i < datos_grupos.length; i++) {
    var fila = crearFila(datos_grupos[i]);
